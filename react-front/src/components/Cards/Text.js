...
function Text() {
    return (
        ...
        <div className="card-group">
          {card.map(({ title, title2, title3, image, image2, image3, url, id , text, text2, text3}) => (
            <div className="container" key={id}>
              <Card imageSource={image} title={title} url={url} text={text}
              
              />  
             <br/>
              <Card imageSource={image3} title={title3} url={url} text={text3}
              
              />
              <br/>
              <Card imageSource={image2} title={title2} url={url} text={text2}
