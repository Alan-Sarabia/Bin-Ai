          ...
          <div className="container" key={id}>
            <div className="row">
              <div className="col-md-4">
                <Card imageSource={image} title={title} url={url} text={text} /><br/>
              </div>
              <div className="col-md-4">
                <Card imageSource={image3} title={title3} url={url3} text={text3} /><br/>
              </div>
              <div className="col-md-4">
                <Card imageSource={image2} title={title2} url={url2} text={text2} /><br/>
              </div>
            </div>
          </div>
